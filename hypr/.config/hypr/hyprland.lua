...
hl.on("hyprland.start", function ()
    -- Always begin a new Hyprland session on the first workspace.
...
hl.config({
    input = {
        ...
        sensitivity = -0.08, -- -1.0 - 1.0, 0 means no modification.
...
-- Target the primary keyboard endpoint
hl.device({
    name = "telink-wireless-gaming-keyboard",
    kb_options = "altwin:swap_lalt_lwin"
})

-- Target the secondary/media endpoint just in case
hl.device({
    name = "telink-wireless-gaming-keyboard-1",
    kb_options = "altwin:swap_lalt_lwin"
})
...
--Launch terminal - check if docked; y: remove ghostty key-remap
hl.bind(mainMod .. " + Return", hl.dsp.exec_cmd([[sh -c 'if hyprctl devices | grep -q "telink"; then ghostty --key-remap=""; else ghostty; fi']]))
